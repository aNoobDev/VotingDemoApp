	   ...
	   <div class="row">
	     <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
	       <div class="card card-signin my-5">
	         <div class="card-body">
	           <h1 class="card-title text-center font-weight-bold text-primary">Enter your Unique ID<%=str %></h1>
	           <form class="form-signin" action="update4" method="post">
	             <div class="form-label-group">
	               <input type="text" name="uid" id="addId" class="form-control edit" placeholder="Unique Id"required autofocus>
